...
class Cricketer:
    ...
    def Batting_Mumbai(self):
        ...
        for squad in range(0, 11):
            ...
            if self.Total_Balls <= 120:
                ...
                self.Total_Runs_Mumbai = self.Runs
        ...
        print("" , end = "\n")
        print("{:<5}{:<25} {:<30} {:<10} {:<10} {:<10} ".format(" ", "Total", " ", self.Total_Runs_Mumbai, "120",self.Total_Sixes), end="\n\n\n")
    ...
    #===================================================================================================================
        ...
        for squad in range(6 , 11):
            ...
            self.Economy = round(self.Runs_given/6 ,1)
    ...
    def Batting_Team_II(self):
        ...
        for squad in range(0, 11):
            ...
            if self.Total_Balls <= 120:
                ...
                self.Total_Balls += self.Balls
                self.Total_Runs_Team_II += self.Runs

            else:
                break

        print("", end="\n")
        print("{:<5}{:<25} {:<30} {:<10} {:<10} {:<10} ".format(" ", "Total", " ", self.Total_Runs_Team_II, "120",
